...
private:
    ...
    /** Get a Unicode glyph or short text string for a ReelSymbol. */
    static juce::String getSymbolDisplayText (ReelSymbol symbol);

    /** Get the neon accent colour associated with a symbol. */
    static juce::Colour getSymbolColour (ReelSymbol symbol);
